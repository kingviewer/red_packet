...
window.onload = function() {
    ...
    window.myPolarArea = Chart.PolarArea(ctx9, config9);

    // 10
    window.myRadar = new Chart(document.getElementById('canvas10'), config10);
    ...
    window.myLine = new Chart(ctx12, config12);
