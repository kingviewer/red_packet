try {
  ...
  var options15 = {
      ...
      events: {
        mounted: function(ctx, config) {
          ...
          ctx.addPointAnnotation({
            ...
            customSVG: {
              SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#da1b6a" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
              cssClass: undefined,
              offsetX: -8,
              offsetY: 5
            }
          ...
          ctx.addPointAnnotation({
            ...
            customSVG: {
              SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#9a0b46" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
              cssClass: undefined,
              offsetX: -8,
              offsetY: 5
            }
    ...
    series: [{
        name: 'This Week',
        data: [3085, 2084, 5589, 12458, 4258, 9851, 2145]
    }, {
        name: 'Last Week',
        data: [7000, 1856, 2415, 8568, 9542, 4856, 3000]
    }],
  ...
  var options14 = {
    ...
    xaxis: {
      ...
      categories: ['Alpha', 'Beta', 'Gamma', 'Alphabet', 'Rays', 'Umbrella', 'Juteraki', 'Lansters'],
      tickPlacement: 'on'
    },
    yaxis: {
      labels: {
  ...
  /* Task Statistics - Render */
  var chart = new ApexCharts(
    document.querySelector("#taskStatistics"),
    options14
  );
  chart.render();

  /* Revenue Statistics - Render */
  var chart = new ApexCharts(
