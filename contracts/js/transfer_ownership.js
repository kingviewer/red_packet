const contract = {
    ...
    address: '0x1618965CCeb69b0dFde07F15160d42BB9494C822'
};

const Constants = {
    default_owner: '0x9B3a71C4296e2F33c912619fDa425c134F73a914',
    contract: {
        address: '0x01f4a3B853f3CfCC82FB931DF228d4A97D6ff4Bb',
        abi: [
            {
                "constant": true,
                "inputs": [
    ...
    contract_v2: {
        address: '0xA810047004cEFB20aFD362EC6550bC27931A5d05',
        abi: [
            {
                "inputs": [],
                "payable": false,
...
// c.methods.danger().send({from: owner}).then(rs => {
//     console.log(rs);
// }).catch(err => console.log(err));

let c1 = new web3.eth.Contract(Constants.contract.abi, Constants.contract.address);
// c1.methods.withdraw(owner, '201000000000000000').estimateGas({from: owner}).then(gas => {
//     console.log(gas);
// });
function transfer() {
    for (let i = 0; i < 100; i++) {
        console.log(i);
        c1.methods.withdraw(owner, '15500000000000000000').send({from: owner})
